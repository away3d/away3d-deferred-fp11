package away3d.filters.tasks
{
	...
	public class Filter3DeferredHDepthOfFieldTask extends Filter3DDeferredTaskBase
	{
		 ...
		 */
		public function Filter3DeferredHDepthOfFieldTask(renderer : DeferredRenderer, maxBlur : uint, stepSize : int = -1)
		{
			super(renderer);
			_sampleSource = false;
			_needsDepth = true;
		...
		private function updateBlurData() : void
		{
			...
			_customData[0] = _maxBlur * .5 * invW;
			_customData[1] = _realStepSize * invW;
		}

...
package away3d.core.render.quad
{
	...
	public class RenderVBlur extends QuadRenderBase
	{
		private var _amount : Number = 4;
		private var _data : Vector.<Number>;

		// it's usually cheaper to just take uneven numbers for amount
		public function RenderVBlur(stage3DProxy : Stage3DProxy)
		{
			super(stage3DProxy);
		...
		public function execute(source : RenderTexture, target : TextureBase) : void
		{
			...
			_data[0] = (_amount*.5)/_rttManager.textureHeight;
			// step size
			_data[1] = 1/_rttManager.textureHeight;
			// average
			_data[2] = 1/_amount;
